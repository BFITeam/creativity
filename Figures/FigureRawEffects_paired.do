...
graph twoway (bar coefficient treatment, fcolor(emidblue) barwidth(0.8))(rcap high low treatment, lwidth(thick)), 	///
	...
	saving("$mypath\Figures\Graphs\Figure2a_paired.gph", replace) 
	graph export "$mypath\Figures\Graphs\Figure2a_paired.ps", logo(off) replace
...
graph twoway (bar coefficient treatment, fcolor(emidblue) barwidth(0.8))(rcap high low treatment, lwidth(thick)), 	///
	...
	saving("$mypath\Figures\Graphs\Figure2b_paired.gph", replace) 
	graph export "$mypath\Figures\Graphs\Figure2b_paired.ps", logo(off) replace
