...
bplot_bonus_neg2<-barplot(as.numeric(bar_chart_coef[,1]),col=c("blue","darkred")[rep(1:2,4)],ylim=c(-1,1.2),yaxt="n",density=c(NA,70),space=c(0.3,0.3,0.3,0.3,1.2,0.3,0.3,0.3))
